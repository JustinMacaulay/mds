...
from ..party_appt.resources.mine_party_appt_resource import MinePartyApptResource, MinePartyApptListResource
...
api.add_resource(MinePartyApptListResource, '/mines')
api.add_resource(MinePartyApptResource, '/mines/<string:mine_party_appt_guid>')
