...
MINE_PARTY_APPT = api.model(
    'MinePartyAppointment', {
        ...
        'party': fields.Nested(BASE_PARTY, allow_null=True)
    })

MINE_PARTY_APPT_WITH_PARTY = api.model(
    'MinePartyAppointment', {
        'mine_party_appt_guid': fields.String,
        'mine_guid': fields.String,
        'party_guid': fields.String,
...
PARTY = api.inherit(
    'Party', BASE_PARTY, {
        ...
        'mine_party_appt': fields.List(fields.Nested(MINE_PARTY_APPT)),
    })
...
SUBDIVISION_CODE_MODEL = api.model('SubDivisionCode', {
    'sub_division_code': fields.String,
